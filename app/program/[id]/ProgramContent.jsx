...
const FloatingIcon = ({ src, alt, className, speed = 1 }) => {
    ...
    return (
        ...
        >
            <div className="relative p-3 rounded-2xl bg-white/10 backdrop-blur-md border border-white/20 shadow-2xl animate-float">
    ...
    return (
        <div ref={containerRef} className="min-h-screen bg-[#050505] text-white overflow-hidden selection:bg-primary/30">
            ...
            <div className="relative z-10 max-w-7xl mx-auto px-6 pb-32">
                ...
                <div className="mb-32">
                    <h2 className="text-4xl md:text-6xl font-black mb-16 text-center">What You Will <span className="text-[#a3e635] underline decoration-wavy decoration-2 underline-offset-8">Achieve</span></h2>

                    <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
                        {(program.keyResults || [
                            "Master the process of building with AI", // Updated to match image text if possible
                ...
                <div className="mb-32 text-center">
                    <h2 className="text-4xl md:text-6xl font-black mb-16 text-center">Powered By <span className="text-[#a3e635] underline decoration-wavy decoration-2 underline-offset-8">AI Tools</span></h2>
                ...
                <div className="max-w-5xl mx-auto mb-32">
                    <div className="bg-[#111] rounded-[3rem] border border-[#a3e635]/20 p-8 md:p-12 overflow-hidden relative">
                        ...
                        <div className="relative z-10 grid md:grid-cols-2 gap-12 items-center">
                                ...
                                <div className="space-y-4">
                                    {(program.includes || [
                                        ...
                                        <div key={i} className="flex items-center gap-3">
                                            <div className="w-6 h-6 rounded-full bg-[#a3e635] flex items-center justify-center text-black shrink-0">
                            ...
                            {/* Right: Price & CTA */}
                            <div className="bg-white/5 rounded-[2rem] p-8 border border-white/10 text-center relative backdrop-blur-sm">
                                <p className="text-sm text-gray-500 font-bold uppercase tracking-widest mb-2">Total Value ₹{originalPrice}</p>
                                <div className="text-6xl md:text-7xl font-black text-white mb-2 tracking-tighter">₹{price}</div>
                                <p className="text-sm text-gray-400 mb-8 font-medium">One-time payment • Lifetime access</p>

                                <button
                                    onClick={handleEnroll}
                                    className="w-full py-4 rounded-xl bg-[#a3e635] text-black font-black text-xl hover:scale-105 transition-transform shadow-[0_0_30px_-5px_rgba(163,230,53,0.4)] flex items-center justify-center gap-2 mb-4"
                                >
                                    <Zap className="w-5 h-5 fill-current" /> Enrol Now
                                </button>
                                ...
                                <p className="text-[10px] text-gray-500 mt-2">Secure payment via Razorpay</p>
                            </div>
                        </div>
                    </div>
                </div>
