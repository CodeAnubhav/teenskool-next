        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-10">
          ...
          <div className="md:col-span-2 space-y-4">
            ...
            <div className="flex space-x-4 pt-2">
              {socialLinks.map((social, index) => (
                <a key={index} href={social.href} target="_blank" rel="noopener noreferrer" className="text-slate-400 hover:text-slate-600 transition-colors">
                  {social.icon}
                </a>
              ))}
            </div>
          ...
          <div className="space-y-4">
            ...
            <ul className="space-y-2 text-sm">
              <li key="/">
                  <Link href="/" className="text-slate-600 hover:text-yellow-500 transition-colors">Home</Link>
              </li>
              {quickLinks.map((link) => (
                <li key={link.href}>
                  <Link href={link.href} className="text-slate-600 hover:text-yellow-500 transition-colors">
                    {link.label}
                  </Link>
                </li>
              ))}
          ...
          <div className="space-y-4">
            ...
            <div className="space-y-3 text-slate-600 text-sm">
              <a href="mailto:info@teenskool.in" className="flex items-center gap-3 hover:text-yellow-500 transition-colors">
                <Mail className="h-4 w-4 text-slate-400" />
                info@teenskool.in
              </a>
              <a href="tel:+919876543210" className="flex items-center gap-3 hover:text-yellow-500 transition-colors">
