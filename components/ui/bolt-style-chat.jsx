                        ...
                        <div className="p-1.5">
                            ...
                            {models.map((model) => (
                                <button
                                    ...
                                    className={`w-full flex items-center gap-3 px-2.5 py-2 rounded-lg text-left transition-all duration-150 ${selected.id === model.id
                                ...
                                >
                                    ...
                                    <div className="flex-1 min-w-0">
                                        <div className="flex items-center gap-2">
                                            ...
                                            {model.badge && (
                                                <span
                                                    className={`text-[10px] px-1.5 py-0.5 rounded-full font-medium ${model.badge === "Pro"
...
function ImportButtons({ onImport }) {
    return (
...
export function BoltStyleChat({
    ...
    return (
        <div className="relative flex flex-col items-center justify-center min-h-[600px] h-full w-full overflow-hidden bg-[#0f0f0f] rounded-3xl border border-white/10">
            <RayBackground />
