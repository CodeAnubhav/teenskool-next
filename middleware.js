...
export async function middleware(req) {
    try {
        ...
        // If middleware fails (e.g. Supabase connection issue or missing env vars),
        // don't crash the entire app. Just let the request proceed.
        // Client-side auth protection will still handle security.
        console.error('Middleware process failed:', e);
